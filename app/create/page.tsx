  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-xs text-zinc-500">
                Enter the token contract address or trading pair from DexScreener
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-2 text-xs text-zinc-500">
                Current price of the token. Market settles at midnight.
              </p>
            </div>

            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              <h3 className="font-semibold mb-2 text-purple-400">Market Rules</h3>
              <ul className="space-y-2 text-sm text-zinc-300">
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Markets settle at midnight (00:00 UTC)</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>UP wins if final price {'>'} initial price</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>DOWN wins if final price {'<'} initial price</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Winners can sell outcome tokens, losers cannot</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
            ...
            {!address ? (
              <div className="text-center py-4 px-6 bg-zinc-800 rounded-lg border border-zinc-700">
                <p className="text-zinc-400">Connect your wallet to create a market</p>
              </div>
            ) : (
              <motion.button
                ...
                disabled={!tokenAddress || !initialPrice || isCreating}
        ...
        >
          <p>Markets are automatically settled by keeper bots at midnight</p>
        </motion.div>
      </main>
    </div>
  );
